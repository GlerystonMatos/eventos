        ...
        firebase.auth().createUserWithEmailAndPassword(email, senha).then(resultado => {
            ...
            switch (erro.message) {
                ...
                case 'The email address is badly formatted.':
                    ...
                    break;
                default:
                    setMsg('Não foi possível cadastrar. Teste novamente mais tarde!' + erro.message);
                    break;
            }
        })
    }
    ...
    return (
        <div className="form-cadastro">
            <form className="text-center form-login mx-auto mt-5">
                ...
                {
                    carregando ? <div className="spinner-border text-danger mt-3 mb-5" role="status"> <span className="sr-only">Loading...</span> </div>
